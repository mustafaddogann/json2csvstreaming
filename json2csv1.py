...
def main():
    ...
    if not INPUT_CONTAINER_NAME:
        missing_vars.append("INPUT_CONTAINER_NAME")
    if not INPUT_BLOB_PATH_PREFIX:
        missing_vars.append("INPUT_BLOB_PATH_PREFIX")
    if not OUTPUT_CONTAINER_NAME:
        missing_vars.append("OUTPUT_CONTAINER_NAME")

    if missing_vars:
        print("Missing the following environment variables:")
        for var in missing_vars:
            print(f"  - {var}")
        print("Environment dump (for debugging):")
